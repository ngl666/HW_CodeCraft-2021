...
//                    currentAllServerNodesOrder.pollFirst();
    ...
    public static ArrayList<ArrayList<Integer>> move(int canMoveNumber){
        ...
        if((0.6*currentCpuRatio +0.4*currentRamRatio) <0.85){
...
//            oneDayAddDoubleVm.sort(new Comparator<String>() {
//                @Override
...
//                }
//            });
//            oneDayAddSingleVm.sort(new Comparator<String>() {
//                @Override
//                public int compare(String o1, String o2) {
//                    o1 = o1.substring(1, o1.length() - 1);
//                    String[] oneRequestInfo1 = o1.split(", ");
...
//            oneDayVm.sort(new Comparator<String>() {
//                @Override
//                public int compare(String o1, String o2) {
//                    o1 = o1.substring(1, o1.length() - 1);
//                    String[] oneRequestInfo1 = o1.split(", ");
